    ...
    case 'without': {
      if (callArgs.length === 1) {
        ...
        return [
          ...
          // Including close parenthesis at the end of the call expression node to cover
          // the use case of something.without(1).compact();
          ...
          // Including open paren at the beginning of the call expression node to cover
          // the use case of something.without(1).compact();
